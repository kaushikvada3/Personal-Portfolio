...
## Project Context (Legacy Reference)
- **Three.js:** 3D "Macro-Silicon Laboratory" environment.
- **GSAP (ScrollTrigger):** Cinematic animation timeline.
- **"Macro" Aesthetic:** Tight FOV cameras for close-up detail.
- **"Liquid Glass" UI:** High backdrop-blur (32px), tonal layering.
